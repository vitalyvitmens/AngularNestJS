...
// SETUP ANGULAR ON YOUR LOCAL SYSTEM:
// node -v //чтобы проверить nodeJS 
// npm -v //чтобы проверить установлен ли менеджер пакетов npm

// npm install -g @angular/cli //чтобы УСТАНОВИТЬ Angular CLI
// ng new my-app //создать свой проект с любым названием, выбрать css, на ответы N
// cd my-app //перейдите в папку рабочей области
// ng serve --open //запускаем localhost:4200, на ответы N

// (Если localhost:4200 не запустился: 
